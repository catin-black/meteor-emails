...
export const SessionDataCsvColumnsMapped = new SessionObject('data.csv.columns.mapped');
...
export const SessionDataCsvStatusUploaded = new SessionObject('data.csv.status.uploaded');
export const SessionDataCsvStatusParsed = new SessionObject('data.csv.status.parsed');
export const SessionDataCsvUploadReport = new SessionObject('data.csv.upload.report');
...
export const SessionAuthorizationPasswordToken = new SessionObject('authorization.password.token');