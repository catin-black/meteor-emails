...
import { showDangerNotification, showSuccessNotification } from "/client/helpers/helpers";
...
function actionAfterRegister(error) {

    if (error) {
        showDangerNotification('Logowanie nie powiodło się.')
    } else {
