function displayConfirmation(title, text, callback) {
    ...
    swal({
        ...
        switch (value) {
            case "ok":
                $('body').append('<div id="preloader2"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Please wait. I am doing my job./span></div>');
                callback();
                break;
            default:
                break;
...
export { displayConfirmation as displayConfirmation };